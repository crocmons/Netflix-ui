...
import video from "../assets/CarMovie.mp4"
...
const Card = ({movieData, isLiked=false}) => {
    ...
    onAuthStateChanged(auth,(currentUser)=>{
      ...
      const addToList = async ()=>{
        try{
            await axios.post("https://netflixapp40.herokuapp.com/api/user/add",{email,data:movieData})
        }catch(err){
            console.log(err)
        }
      }
      ...
      <img src={`https://image.tmdb.org/t/p/w500${movieData.image}`} alt="movie"/>
      {
        isHover && (
            <div className="hover">
                ...
                <div className="info-div flex column">
